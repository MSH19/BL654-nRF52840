...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAS_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_IAS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_IAS_SEC_NONE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BL654_DVK, 1);
